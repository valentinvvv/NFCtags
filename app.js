...
const app = {
      ...
      // Temperature presets loaded from external file (presets.js)
      temperaturePresets: (typeof temperaturePresets !== 'undefined' ? temperaturePresets : {}),
      ...
      // Download OpenSpool JSON (NFC format)
      downloadForNFC() {
            const formData = this.getFormData();
